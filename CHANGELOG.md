...
- Detecta patrones de posible abuso de acceso, intentos de asignación no autorizados y ampliaciones de permisos; ofrece alertas privadas para revisión del creador y persistencia acotada.

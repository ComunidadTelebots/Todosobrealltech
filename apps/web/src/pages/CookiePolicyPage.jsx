...
export default function CookiePolicyPage() {
  ...
  return <LegalDocument title="Política de cookies" description="Información y preferencias sobre las cookies de TodoSobreAllTech." icon={Cookie}>
    ...
    <section><h2>3. Analítica</h2><p>La analítica propia registra, cuando la autorizas, vistas de página agrupadas por sección, idioma del navegador, dispositivo y ubicación aproximada por IP. La colección de visitas no guarda la IP ni identificadores de visitante y no calcula personas únicas. El mapa separa web y Hub de los idiomas observados en Telegram.</p><p>Con tu consentimiento, Google Analytics puede medir páginas visitadas, eventos técnicos, dispositivo aproximado y rendimiento. La web mantiene la analítica desactivada antes del consentimiento en las regiones donde este es obligatorio.</p></section>

...
const games = [
  {
    ...
    description: 'Simulador multimodal de transporte por carretera, aire y mar conectado con el Hub de CintiaBot.',
    roadmap: {
      implemented: [
      ...
      partial: [
        ...
        'Interfaz inspirada en Canva integrada por módulos; falta completar todas las pantallas y transiciones visuales',
      ],
      planned: [

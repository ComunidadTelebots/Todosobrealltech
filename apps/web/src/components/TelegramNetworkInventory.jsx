...
export default function TelegramNetworkInventory() {
  return <div className="space-y-3"><details className="rounded-lg border p-3 text-sm">
    ...
    <details className="rounded-lg border p-3 text-sm">
      ...
      <p className="mt-3 text-xs text-muted-foreground">Los <a className="underline" href="https://core.telegram.org/cdn" target="_blank" rel="noreferrer">CDN cifrados de MTProto</a> distribuyen medios públicos populares. Telegram publica sus IPs mediante help.getConfig (opciones con marca cdn); help.getCdnConfig proporciona las claves públicas, no una lista de ciudades. El CDN asignado a una descarga se indica en upload.fileCdnRedirect.</p>
      <p className="mt-2 text-xs text-muted-foreground">El estado del descubrimiento MTProto se muestra en su sección específica. Los hosts web cdn1/cdn4 medidos arriba no representan todos los CDN cifrados. Estos CDN no procesan el envío de mensajes de los bots.</p>

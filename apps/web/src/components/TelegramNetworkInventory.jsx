...
export default function TelegramNetworkInventory() {
  return <div className="space-y-3"><details className="rounded-lg border p-3 text-sm">
    ...
    <details className="rounded-lg border p-3 text-sm">
      ...
      <p className="mt-2 text-xs text-muted-foreground">Descubrimiento MTProto: no conectado en este panel. Los hosts web cdn1/cdn4 medidos arriba no representan todos los CDN cifrados. Estos CDN no procesan el envío de mensajes de los bots.</p>

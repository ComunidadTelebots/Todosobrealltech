...
const empty = { title: '', description: '', url: '', image: '', placement: 'all', placements: ['all'], allowed_sites: ['all'], priority: 50, enabled: true, cta: 'Abrir', background: '#eef7ff', foreground: '#155f9b', accent: '#1982d1', starts_at: '', ends_at: '', max_clicks: 0, max_impressions: 0, display_seconds: 15, frequency_cap: 3, destination_mode: 'single', community_id: '', community_items: [], display_format: 'auto' };

...
export default function MoonbotFeatureCenter() {
  ...
  return <Card className="mt-6">
    ...
    <CardContent className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">{visible.length} de {features.length} funciones accesibles · {groups.length} paneles</p>
